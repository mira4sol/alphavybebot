  ...
  response: {
        ...
        data: {
          items: {
            properties: {
              amount: {
                description:
                  'Amount of NFTs in this collection the address owns',
                format: 'int64',
                type: 'integer',
    ...
    '400': {
      properties: {
        code: {
          description:
            'Code ID of the error, uniquely identifying the error type',
          format: 'int32',
          type: 'integer',
          minimum: -2147483648,
          maximum: 2147483647,
        ...
        id: {
          description:
            'A unique identifier for the error, representing the error ID in Sentry.\nThis should be submitted as a reference when contacting support.',
          type: 'string',
        },
        message: {
          description:
        ...
        violations: {
          description:
            'Optional collection of validation violations representations.',
          items: {
            description:
              'Main structure to represent any kind of validation violation.',
            properties: {
              invalidValue: {
              ...
              propertyPath: {
                description:
                  'Property path to the field where violation occurred.',
                type: 'string',
              },
            },
            required: ['message'],
      ...
      properties: {
        accounts: {
          ...
          items: {
            ...
            required: ['ownerAddress', 'labels', 'dateAdded'],
            type: 'object',
          },
          type: 'array',
        },
        ...
        programs: {
          ...
          items: {
            properties: {
              ...
              idlUrl: { description: 'Program IDL URL', type: 'string' },
              labels: {
                description: 'Program labels, eg: DEFI,NFT',
                items: { type: 'string' },
                type: 'array',
              },
              logoUrl: { description: 'Program logo URL', type: 'string' },
              name: { description: 'Program name', type: 'string' },
              programDescription: {
                description: 'Program description',
                type: 'string',
              },
              programDetail: { description: 'Program detail', type: 'string' },
              programId: { description: 'Program ID', type: 'string' },
              siteUrl: { description: 'Program site URL', type: 'string' },
              twitterUrl: {
                description: 'Twiiter url for the program account',
                type: 'string',
              },
            },
            required: ['programId', 'labels', 'dateAdded'],
            type: 'object',
          },
          type: 'array',
        },
    ...
    '200': {
      properties: {
        data: {
          items: {
            properties: {
              baseTokenMint: { format: 'pubkey', type: 'string' },
              baseTokenName: {
              ...
              marketId: { format: 'pubkey', type: 'string' },
              marketName: { description: 'Name of the market', type: 'string' },
              programId: { format: 'pubkey', type: 'string' },
              programName: {
                description: 'Name of the program',
                type: 'string',
              },
              quoteTokenMint: { format: 'pubkey', type: 'string' },
              quoteTokenName: {
...
const GetPairTradeOhlcvProgram = {
  metadata: {
    allOf: [
      {
        type: 'object',
        ...
        required: ['baseMintAddress', 'quoteMintAddress'],
      },
      {
        type: 'object',
        properties: {
          ...
          limit: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Limit of the number of candles to return per page. Default is 1000.',
          },
        },
        required: [],
      },
    ...
    '200': {
      properties: {
        data: {
          ...
          items: {
            properties: {
              close: { description: 'Close price', type: 'string' },
              count: {
              ...
              high: { description: 'High price', type: 'string' },
              low: { description: 'Low price', type: 'string' },
              open: { description: 'Open price', type: 'string' },
              time: { description: 'OHLC time bucket start', type: 'string' },
              volume: { description: 'Volume', type: 'string' },
            },
            required: [
              'time',
              'open',
  ...
  response: {
    '200': {
      properties: {
        ...
        friendlyName: { description: 'Friendly name', type: 'string' },
        idlUrl: { description: 'Program IDL URL', type: 'string' },
        instructions1d: {
        ...
        data: {
          ...
          items: {
            properties: {
              ...
              wallet: { description: "User's wallet id", type: 'string' },
            },
            required: ['programId', 'wallet', 'transactions', 'instructions'],
            type: 'object',
          },
          type: 'array',
        },
...
const GetProgramActiveUsersCount = {
  metadata: {
    allOf: [
      {
        type: 'object',
        ...
        data: {
          items: {
            properties: {
              ...
              dau: {
                description:
                  'Count of unique fee payers in the selected resolution',
                format: 'int64',
                type: 'integer',
                minimum: -9223372036854776000,
                maximum: 9223372036854776000,
            ...
            required: ['programId', 'dau', 'blockTime'],
            type: 'object',
          },
          type: 'array',
        },
...
const GetProgramInstructionsCount = {
  metadata: {
    allOf: [
      {
        type: 'object',
      ...
      properties: {
        data: {
          ...
          items: {
            ...
            required: ['programId', 'instructionsCount', 'blockTime'],
            type: 'object',
          },
          type: 'array',
        },
...
const GetProgramTransactionsCount = {
  metadata: {
    allOf: [
      {
        type: 'object',
      ...
      properties: {
        data: {
          ...
          items: {
            ...
            required: ['programId', 'transactionsCount', 'blockTime'],
            type: 'object',
          },
          type: 'array',
        },
      ...
      },
      {
        ...
        properties: {
          resolution: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Resolution of the data. Possible values: 1h, 1d, 1w or a string parseable to seconds',
          },
        },
        required: ['resolution'],
      },
        ...
        data: {
          ...
          items: {
            properties: {
              ...
              tvl: { description: 'Programs TVL', type: 'string' },
            },
            required: ['tvl', 'time'],
            type: 'object',
          },
    ...
    allOf: [
      {
        ...
        properties: {
          ...
          sortByAsc: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              "Sort ascending by 'dau', 'name', 'transactions1d' or 'instructions1d'. Only one of sort_by_asc or sort_by_desc can be used",
          },
          sortByDesc: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              "Sort descending by 'dau', 'name', 'transactions1d' or 'instructions1d'. Only one of sort_by_asc or sort_by_desc can be used",
          },
        },
        required: [],
      },
  ...
  response: {
    '200': {
      ...
      properties: {
        confidence: {
          description:
            "Confidence interval of how close we think the true price is to the average.\nIt's influenced by both how sure each person quoting the price is, and how much they agree with each other.",
          type: 'string',
        },
        emac1H: {
          description:
            'Exponentially-weighted moving average confidence interval is a time-weighted average of the confidence interval',
          type: 'string',
        },
        emap1H: {
          description:
            'Exponentially-weighted moving average price is a time-weighted average of the aggregate price',
          type: 'string',
        },
        lastUpdated: {
        ...
        priceFeedAccount: { format: 'pubkey', type: 'string' },
        validSlot: {
    ...
    '200': {
      properties: {
        data: {
          items: {
            properties: {
              avgConf: { description: 'Average confidence', type: 'string' },
              avgPrice: { description: 'Average price', type: 'string' },
              close: { description: 'Close price', type: 'string' },
              high: { description: 'High price', type: 'string' },
              low: { description: 'Low price', type: 'string' },
              open: { description: 'Open price', type: 'string' },
...
const GetPythPriceProductPairs = {
  metadata: {
    allOf: [
      {
        type: 'object',
        ...
        data: {
          items: {
            properties: {
              priceFeedId: {
                description:
                  'The pubkey identifying the Pyth Price feed account.',
                type: 'string',
              },
              productId: {
              ...
              symbol: { description: 'The Pyth asset symbol', type: 'string' },
            },
            required: ['productId', 'priceFeedId', 'symbol'],
            type: 'object',
          },
          type: 'array',
        },
...
const GetPythProduct = {
  ...
  response: {
    '200': {
      description:
        'Structure corresponding to what we will fetch in the API\nThis is saved to a json file',
      oneOf: [
        {
          required: ['genericSymbol', 'schedule'],
          type: 'object',
          properties: {
            genericSymbol: { description: 'Ticker symbol', type: 'string' },
            schedule: { description: 'Weekly schedule', type: 'string' },
            assetType: {
              description:
                'The asset class: Crypto, Equity, FX, Metal, Rates, Commodities',
              type: 'string',
            },
            base: {
              description:
                'Base asset. Can be present for everything except rates and commodities.',
              type: 'string',
            },
            country: {
            ...
            description: { description: 'Pair name', type: 'string' },
            productId: {
              description: 'The pubkey identifying the Pyth Product.',
              type: 'string',
            },
            quote: {
              description:
                'Quote currency. Can be present for everything except rates and commodities.',
              type: 'string',
            },
            symbol: { description: 'Pyth asset symbol', type: 'string' },
            tenor: {
        ...
        {
          required: ['cmsSymbol', 'cqsSymbol', 'nasdaqSymbol', 'schedule'],
          type: 'object',
          properties: {
            cmsSymbol: { description: 'CMS market symbol', type: 'string' },
            cqsSymbol: { description: 'CQS market symbol', type: 'string' },
            nasdaqSymbol: {
        ...
        {
          required: ['genericSymbol', 'umtf'],
          type: 'object',
          properties: {
            genericSymbol: { description: 'Ticker symbol', type: 'string' },
            umtf: { description: 'UMTF', type: 'string' },
            assetType: {
              description:
                'The asset class: Crypto, Equity, FX, Metal, Rates, Commodities',
              type: 'string',
        ...
        {
          required: ['cmsSymbol', 'cqsSymbol', 'nasdaqSymbol', 'umtf'],
          type: 'object',
          properties: {
            cmsSymbol: { description: 'CMS market symbol', type: 'string' },
            cqsSymbol: { description: 'CQS market symbol', type: 'string' },
      ...
      required: ['productId', 'description', 'symbol', 'assetType'],
      type: 'object',
      $schema: 'http://json-schema.org/draft-04/schema#',
    },
    '400': {
...
const GetTokenDetails = {
  ...
  response: {
    '200': {
      properties: {
        category: { description: 'Category of the token', type: 'string' },
        currentSupply: {
        ...
        name: { description: 'Token mint name', type: 'string' },
        price: {
        ...
        symbol: { description: 'Token mint symbol', type: 'string' },
...
const GetTokenHoldersTimeSeries = {
  metadata: {
    allOf: [
      {
        type: 'object',
      ...
      },
      {
        ...
        properties: {
          ...
          interval: {
            description:
              'Time interval specifier (currently, only "day" is supported).',
            enum: ['day'],
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
          },
      ...
      properties: {
        data: {
          ...
          items: {
            ...
            required: ['holdersTimestamp', 'nHolders'],
            type: 'object',
          },
          type: 'array',
        },
...
const GetTokenInstructionNames = {
  metadata: {
    allOf: [
      {
        type: 'object',
    ...
    '200': {
      properties: {
        data: {
          items: {
            properties: {
              callingInstructions: { format: 'binary', type: 'string' },
              callingProgram: { type: 'string' },
              ixName: { type: 'string' },
              programName: { type: 'string' },
            },
            required: [
      ...
      },
      {
        ...
        properties: {
          resolution: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Resolution of the data. Possible values: 1s, 1m, 3m, 5m, 15m, 30m, 1h, 2h, 3h, 4h, 1d, 1w, 1mo, 1y. Default is "1d".',
          },
          timeStart: {
            format: 'int64',
            minimum: 0,
        ...
        data: {
          ...
          items: {
            properties: {
              ...
              time: { description: 'OHLC time bucket start', type: 'string' },
              volume: { description: 'Volume', type: 'string' },
              volumeUsd: { description: 'Volume in USD', type: 'string' },
            },
            required: [
              'time',
              'open',
        ...
        transfers: {
          ...
          items: {
            properties: {
              amount: {
                description:
                  'The total number of tokens involved in the transaction.',
                format: 'int64',
                minimum: 0,
                type: 'integer',
                maximum: 9223372036854776000,
              ...
              blockTime: {
                description:
                  'The timestamp when the transaction was confirmed on the blockchain, in Unix time.',
                format: 'int64',
                type: 'integer',
                minimum: -9223372036854776000,
                maximum: 9223372036854776000,
              ...
              calculatedAmount: {
                description:
                  'The resulting amount after applying the `decimal` to the `amount` value.',
                type: 'string',
              },
              callingMetadata: {
                description:
                  'The public key of the Solana program that initiated the transaction.',
                items: {
                  properties: {
                    callingInstructions: { format: 'binary', type: 'string' },
                    callingProgram: { type: 'string' },
              ...
              decimal: {
                description:
                  "The number of decimal places used for the token's smallest unit.",
                format: 'int64',
                minimum: 0,
                type: 'integer',
                maximum: 9223372036854776000,
              ...
              mintAddress: {
                description:
                  "The public key of the token's mint, specifying the token type involved in the transaction.",
                type: 'string',
              },
              price: {
                description:
                  'Price of the token involved in the transaction (e.g. `mint_address`) expressed in USD.',
                type: 'string',
              },
              receiverAddress: {
                description:
                  'The public key of the account receiving the tokens.',
                type: 'string',
              },
              receiverTokenAccount: {
                description:
                  'The public key of the specific token account of the receiver.',
                type: 'string',
              },
              senderAddress: {
                description:
                  'The public key of the account sending the tokens.',
                type: 'string',
              },
              senderTokenAccount: {
                description:
                  'The public key of the specific token account of the sender.',
                type: 'string',
              },
              signature: {
                description:
                  'The cryptographic signature that uniquely identifies the transaction on the blockchain.',
                type: 'string',
              },
              slot: {
                description:
                  'The slot number in which the transaction was processed on the Solana blockchain, helping to pinpoint the exact sequence of events.',
                format: 'int64',
                minimum: 0,
                type: 'integer',
                maximum: 9223372036854776000,
              ...
              valueUsd: {
                description:
                  'Calculated total USD value of the transfer based on the `amount`, `decimal`, and `price` values.',
                type: 'string',
              },
            },
            required: [
...
const GetTokenVolumeTimeSeries = {
  metadata: {
    allOf: [
      {
        type: 'object',
      ...
      properties: {
        data: {
          items: {
            ...
            required: ['timeBucketStart', 'volume', 'amount'],
            type: 'object',
          },
          type: 'array',
        },
    ...
    allOf: [
      {
        ...
        properties: {
          sortByAsc: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Optional ascending sort field specification. Only one of sort_by_asc or sort_by_desc can be used',
          },
          sortByDesc: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Optional descending sort field specification. Only one of sort_by_asc or sort_by_desc can be used',
          },
          limit: {
            format: 'int32',
            minimum: 0,
        ...
        data: {
          items: {
            properties: {
              ...
              usdValueVolume24h: {
                description:
                  'Token volume transferred in past 24 hours USD value',
                format: 'double',
                type: 'number',
                minimum: -1.7976931348623157e308,
                maximum: 1.7976931348623157e308,
    ...
    '200': {
      properties: {
        data: {
          items: {
            properties: {
              balance: { description: 'Current Token Amount', type: 'string' },
              ownerAddress: { description: 'Holder address', type: 'string' },
              ownerLogoUrl: { description: 'Holder logo url', type: 'string' },
              ownerName: { description: 'Holder name', type: 'string' },
              ...
              valueUsd: { description: 'Value Usd', type: 'string' },
            },
            required: [
              'rank',
              'ownerAddress',
        ...
        data: {
          ...
          items: {
            properties: {
              ...
              iixOrdinal: {
                description:
                  'The location of the trade inner ix inside the transaction. 255 is returned if not applicable.',
                format: 'int32',
                minimum: 0,
                type: 'integer',
                maximum: 2147483647,
              ...
              interIxOrdinal: {
                description:
                  'The location of the trade inside an ix (in 2 hop swaps). 255 is returned if not applicable.',
                format: 'int32',
                minimum: 0,
                type: 'integer',
                maximum: 2147483647,
              ...
              ixOrdinal: {
                description:
                  'The location of the trade ix inside the transaction.',
                format: 'int32',
                minimum: 0,
                type: 'integer',
                maximum: 2147483647,
              ...
              marketId: {
                description:
                  'The identifier for the market pair, e.g., SOL/USDC, where the trade took place.',
                type: 'string',
              },
              price: {
                description:
                  'The price of one unit of the base token, expressed in terms of the quote token.',
                type: 'string',
              },
              programId: {
                description:
                  'The public key of the AMM or DEX program that facilitated the trade.',
                type: 'string',
              },
              quoteMintAddress: {
                description:
                  'The mint address of the quote token used in the trade.',
                type: 'string',
              },
              quoteSize: {
                description:
                  'The amount of the quote token exchanged in the trade.',
                type: 'string',
              },
              signature: {
                description:
                  'The unique identifier of the transaction signature on the blockchain.',
                type: 'string',
              },
              slot: {
  ...
  response: {
    '200': {
      properties: {
        data: {
          ...
          items: {
            properties: {
              ...
              logoUrl: { description: 'Logo URL for the NFT', type: 'string' },
              name: { description: 'Symbol for the NFT', type: 'string' },
              priceSol: {
              ...
              slot: {
                description:
                  'Slot for the most recent update to the NFT balance',
                format: 'int64',
                type: 'integer',
                minimum: -9223372036854776000,
                maximum: 9223372036854776000,
        ...
        ownerAddress: { format: 'pubkey', type: 'string' },
        ...
        totalSol: { description: 'Value of the wallet in SOL', type: 'string' },
        totalUsd: { description: 'Value of the wallet in USD', type: 'string' },
      },
      required: [
        'date',
        'ownerAddress',
      ...
      },
      {
        ...
        properties: {
          ...
          tokenAddress: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The token address filter for tokens. Provides the token address to filter the requested data by.',
          },
          sortByAsc: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              "Sort ascending by 'tokenAddress', 'tokenSymbol', 'buysTransactionCount', 'buysTokenAmount', 'buysVolumeUsd', 'sellsTransactionCount', 'sellsTokenAmount', 'sellsVolumeUsd', 'realizedPnlUsd', 'unrealizedPnlUsd'. Only one of sort_by_asc or sort_by_desc can be used.",
          },
          sortByDesc: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              "Sort descending by 'tokenAddress', 'tokenSymbol', 'buysTransactionCount', 'buysTokenAmount', 'buysVolumeUsd', 'sellsTransactionCount', 'sellsTokenAmount', 'sellsVolumeUsd', 'realizedPnlUsd', 'unrealizedPnlUsd'. Only one of sort_by_asc or sort_by_desc can be used.",
          },
          limit: {
            format: 'int32',
            minimum: 0,
        ...
        summary: {
          ...
          properties: {
            ...
            bestPerformingToken: {
              ...
              required: ['tokenSymbol', 'tokenAddress', 'pnlUsd'],
              type: 'object',
              properties: {
                pnlUsd: {
            ...
            pnlTrendSevenDays: {
              description:
                'The profit and loss trend over the last seven days.',
              items: {
                items: {
                  format: 'double',
                  type: 'number',
            ...
            properties: {
              buys: {
                ...
                properties: {
                  tokenAmount: {
                    description:
                      'The total volume of tokens traded on this side.',
                    format: 'double',
                    type: 'number',
                    minimum: -1.7976931348623157e308,
                    maximum: 1.7976931348623157e308,
                  ...
                  volumeUsd: {
                    description:
                      'The total traded volume expressed in USD on this side.',
                    format: 'double',
                    type: 'number',
                    minimum: -1.7976931348623157e308,
                    maximum: 1.7976931348623157e308,
                ...
                required: ['volumeUsd', 'tokenAmount', 'transactionCount'],
                type: 'object',
              },
              realizedPnlUsd: {
              ...
              unrealizedPnlUsd: {
                description:
                  'The total unrealized profit in USD for this token.',
                format: 'double',
                type: 'number',
                minimum: -1.7976931348623157e308,
                maximum: 1.7976931348623157e308,
      ...
      },
      {
        ...
        properties: {
          ...
          oneDayTradeMinimum: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The minimum number of trades in the past 24 hours for a token to be considered in the results. Defaults to 100.',
          },
          oneDayTradeVolumeMinimum: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The minimum amount of trade volume (in USD) in the past 24 hours for a token to be considered in the results. Defaults to 100,000.',
          },
          holderMinimum: {
            format: 'int64',
            minimum: 0,
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The minimum number of holders for a token to be considered in the results. Defaults to 50.',
          },
          minAssetValue: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The minimum amount of total value in USD for an asset to be considered in the results. Defaults to 0.',
          },
          maxAssetValue: {
            type: 'string',
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The maximum amount of total value in USD for an asset to be considered in the results. Defaults to no limit.',
          },
          limit: {
            format: 'int32',
            minimum: 0,
        ...
        required: ['minAssetValue', 'maxAssetValue'],
      },
    ],
  },
  response: {
    '200': {
      properties: {
        ...
        data: {
          ...
          items: {
            properties: {
              amount: { description: 'Amount of the token', type: 'string' },
              category: {
              ...
              name: {
                description:
                  'Name for the token, can be null for unknown addresses',
                type: 'string',
              },
              priceUsd: {
              ...
              priceUsd1dChange: {
                description:
                  'Change in the price of the token in USD over the last 24 hours',
                type: 'string',
              },
              priceUsd7dTrend: {
              ...
              slot: {
                description:
                  'Slot for the most recent update to the token balance. May be 0 if no information is available',
                format: 'int64',
                type: 'integer',
                minimum: -9223372036854776000,
                maximum: 9223372036854776000,
              ...
              symbol: {
                description:
                  'Symbol for the token, can be null for unknown addresses',
                type: 'string',
              },
              valueUsd: {
              ...
              valueUsd1dChange: {
                description:
                  'Change in the value of the held tokens in USD over the last 24 hours',
                type: 'string',
              },
              verified: {
        ...
        totalTokenValueUsd1dChange: {
          description:
            'Change in the value of the wallet in USD over the last 24 hours',
          type: 'string',
        },
      },
      required: [
      ...
      },
      {
        ...
        properties: {
          ...
          onlyVerified: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'Whether only verified tokens should be included in the results. Default is false.',
          },
          oneDayTradeMinimum: {
            format: 'int64',
            minimum: 0,
        ...
        data: {
          items: {
            properties: {
              blockTime: {
                description:
                  'The timestamp, rounded to the day, of which this account snapshot was taken',
                format: 'int32',
                minimum: 0,
                type: 'integer',
                maximum: 2147483647,
  ...
  body: {
    properties: {
      ...
      wallets: {
        ...
        items: { format: 'pubkey', type: 'string' },
        type: 'array',
      },
    },
    required: ['wallets'],
...
const PostWalletTokensMany = {
  body: {
    ...
    required: ['wallets', 'minAssetValue', 'maxAssetValue'],
    type: 'object',
    $schema: 'http://json-schema.org/draft-04/schema#',
  },
  response: {
    '200': {
      properties: {
        ...
        totalTokenValueUsd1dChange: {
          description:
            'Change in the value of the tokens in the wallet in USD over the last 24 hours',
          type: 'string',
        },
      },
      required: [
    ...
    allOf: [
      {
        ...
        properties: {
          ...
          interval: {
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              "Interval between the ranks - default is 1 day\nPossible values: '1d', '7d' or '30d'",
          },
          date: {
            format: 'int64',
            type: 'integer',
            ...
            $schema: 'http://json-schema.org/draft-04/schema#',
            description:
              'The date to return the ranks for in unix timestamp - default is the current date',
          },
        },
        required: [],
      },
  ...
  response: {
    '200': {
      properties: {
        data: {
          ...
          items: {
            properties: {
              ...
              programName: {
                description:
                  'Program Name - null if we dont have it in the dict',
                type: 'string',
              },
              programRank: {
            ...
            required: ['programRank', 'programId', 'score'],
            type: 'object',
          },
          type: 'array',
        },
        ...
        interval: {
          description:
            "Interval between the ranks - Possible values: '1d', '7d' or '30d'",
          type: 'string',
        },
        limit: {
      ...
      required: ['date', 'interval', 'limit', 'data'],
      type: 'object',
      $schema: 'http://json-schema.org/draft-04/schema#',
    },
    '400': {
    ...
    allOf: [
      {
        ...
        properties: {
          trades: {
            items: {
              properties: {
                authorityAddress: { format: 'pubkey', type: 'string' },
                baseMintAddress: { format: 'pubkey', type: 'string' },
                feePayer: { format: 'pubkey', type: 'string' },
                marketId: { format: 'pubkey', type: 'string' },
                programId: { format: 'pubkey', type: 'string' },
                quoteMintAddress: { format: 'pubkey', type: 'string' },
                tokenMintAddress: { format: 'pubkey', type: 'string' },
              },
              type: 'object',
            },
            type: 'array',
          ...
          transfers: {
            items: {
              properties: {
                ...
                maxAmount: {
                  description:
                    'Inclusive maximum of transfered amount\nCan be combined with [Self::min_amount]',
                  format: 'int64',
                  minimum: 0,
                  type: 'integer',
                  maximum: 9223372036854776000,
                ...
                minAmount: {
                  description:
                    'Inclusive minimum of transfered amount\nCan be combined with [Self::max_amount]',
                  format: 'int64',
                  minimum: 0,
                  type: 'integer',
                  maximum: 9223372036854776000,
                ...
                programId: { format: 'pubkey', type: 'string' },
                receiverAddress: { format: 'pubkey', type: 'string' },
                receiverTokenAccount: { format: 'pubkey', type: 'string' },
                senderAddress: { format: 'pubkey', type: 'string' },
                senderTokenAccount: { format: 'pubkey', type: 'string' },
                tokenMintAddress: { format: 'pubkey', type: 'string' },
              },
              type: 'object',
            },
          ...
          oraclePrices: {
            items: {
              properties: {
                priceFeedAccount: { format: 'pubkey', type: 'string' },
                productAccount: { format: 'pubkey', type: 'string' },
              },
              type: 'object',
            },
            type: 'array',
  ...
  response: {
    ...
    '203': {
      properties: {
        ...
        callingPrograms: {
          description:
            'An array of all the programs that were utilized during the transaction If a specific program is used as a filter in the query, it may appear in the CallingPrograms array alongside other programs that were also part of the transaction.',
          items: { type: 'string' },
          type: 'array',
        },
        decimal: {
...
export {
  GetCollectionOwners,
  GetKnownAccounts,
  GetKnownProgramAccounts,
  GetMarketFilteredOhlcv,
  GetMarkets,
  GetPairTradeOhlcvProgram,
  GetProgram,
  GetProgramActiveUsers,
  GetProgramActiveUsersCount,
  GetProgramInstructionsCount,
  GetProgramTransactionsCount,
  GetProgramTvl,
  GetPrograms,
  GetProgramsList,
  GetPythPrice,
  GetPythPriceOhlc,
  GetPythPriceProductPairs,
  GetPythPriceTs,
  GetPythProduct,
  GetTokenDetails,
  GetTokenHoldersTimeSeries,
  GetTokenInstructionNames,
  GetTokenTradeOhlc,
  GetTokenTransfers,
  GetTokenVolumeTimeSeries,
  GetTokensSummary,
  GetTopHolders,
  GetTradeDataProgram,
  GetWalletNfts,
  ...
  GetWalletTokensTs,
  PostWalletNftsMany,
  PostWalletTokensMany,
  PostWalletTokensTsMany,
  Ranking,
  WebsocketRoute,
}
